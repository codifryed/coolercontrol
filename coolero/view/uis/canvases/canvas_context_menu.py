...
class CanvasContextMenu:
    ...
    def __init__(self,
        ...
        self.item_input_values = MenuItem(axes, 'input', callback=callback_input_values)
        ...
        self.menu_items: List[MenuItem] = [
            self.item_add_point, self.item_remove_point, self.item_input_values,
