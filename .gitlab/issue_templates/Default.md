...
```bash
journalctl --no-pager -u coolercontrold -n 10000 > ~/Documents/coolercontrold.log
```
...
kernel drivers. See [Hardware Support](https://docs.coolercontrol.org/hardware-support.html).
