...
| Aquacomputer D5 Next                                                              | <sup>experimental [see liquidctl](https://github.com/liquidctl/liquidctl/blob/main/docs/aquacomputer-d5next-guide.md)</sup>                 |
| Aquacomputer Octo                                                                 | <sup>experimental [see liquidctl](https://github.com/liquidctl/liquidctl/blob/main/docs/aquacomputer-octo-guide.md)</sup>                   |
| Aquacomputer Quadro                                                               | <sup>experimental [see liquidctl](https://github.com/liquidctl/liquidctl/blob/main/docs/aquacomputer-quadro-guide.md)</sup>                 |
| Aquacomputer Farbwerk 360                                                         | <sup>experimental [see liquidctl](https://github.com/liquidctl/liquidctl/blob/main/docs/aquacomputer-farbwerk360-guide.md)</sup>            |
