...
- Lots of little annoying bug fixes
- Control settings are applied on boot
- Improved resource usage
- Decoupled GUI - run when you want
- Set and forget
- Can run on a headless server
- SystemD integration
- Improved multi-device communication
- Readable & changeable configuration files
- System level packaging (deb, rpm, etc)
- No udev rules to apply
- Enabling features like:
    - Remote control
    - GPU Fan control
    - Improved Thinkpad integration
    - etc
...
- Last set profiles are saved and applied on boot.
