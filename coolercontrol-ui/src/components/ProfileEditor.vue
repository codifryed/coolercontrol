  ...
  <div class="flex main-grid">
    ...
    <div class="flex-grow-1">
      <div class="grid" v-show="showGraph">
        ...
        <div class="col-6">
          <InputNumber placeholder="Duty" v-model="selectedDuty" inputId="selected-duty" mode="decimal" suffix="%"
                       showButtons :min="0" :max="100" :disabled="selectedPointIndex == null" :input-style="{width: '58px'}"
                       class="ml-4 mr-3"
          />
          <InputNumber placeholder="Temp" v-model="selectedTemp" inputId="selected-temp" mode="decimal" suffix="°"
                       showButtons :min="0" :max="100" :disabled="!selectedPointIndex" buttonLayout="horizontal"
                       incrementButtonIcon="pi pi-angle-right" decrementButtonIcon="pi pi-angle-left" :step="0.1"
