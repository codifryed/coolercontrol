        ...
        <popover-root>
            ...
            <popover-content side="right" class="z-10">
                ...
                >
                    ...
                    preferences. You can chose between time-based or table-based charts and easily
                    adjust the filters and settings for each chart to focus on the specific data you
                    want to analyze. Additionally, you can create individual dashboards customized
                    to suit your needs.
                </div>
            </popover-content>
        </popover-root>
