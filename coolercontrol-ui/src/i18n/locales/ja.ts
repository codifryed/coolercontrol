...
export default {
    ...
    views: {
        ...
        speed: {
            ...
            applySetting: '設定を適用',
            defaultProfileInfo:
                'デフォルトプロファイルはデバイスを元のドライバー設定に復元します。<br/>一部のドライバーには自動ファン制御モードが組み込まれていますが、<i>多く</i>のドライバーにはありません。<br/>自動制御のないデバイスの場合、デフォルトプロファイルを適用すると<br/>ファンは最後に設定された速度のままとなり、CoolerControlは制御を放棄します。',
        },
        customSensors: {
            newSensor: '新しいセンサー',
            sensorType: 'センサータイプ',
