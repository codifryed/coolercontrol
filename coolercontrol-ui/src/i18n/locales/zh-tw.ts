...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTest: '熱壓力測試',
            stressTestTooltip:
                '生成持續熱負載以驗證<br>風扇曲線和冷卻配置文件。<br>這不是基準測試，而是一種方便的發熱工具，<br>不用於效能測量。<br>可能會降低介面回應速度。',
            cpuStress: 'CPU 壓力',
            gpuStress: 'GPU 壓力',
            gpuStressTooltip: '可能需要 Vulkan 或 OpenGL ES 驅動程式。',
            ramStress: 'RAM 壓力',
            driveStress: '磁碟壓力',
            driveStressTooltip:
                '對區塊裝置進行唯讀 I/O 壓力測試。<br>使用 O_DIRECT 隨機讀取在磁碟控制器上<br>產生熱量，不會造成任何磨損。<br>不會向磁碟寫入任何資料。',
            selectDrive: '選擇磁碟',
            threadCount: '執行緒數',
            duration: '持續時間 (秒)',
            start: '開始',
