...
export default {
    ...
    layout: {
        ...
        settings: {
            ...
            tooltips: {
                ...
                exportThemeFile: '將目前自訂主題儲存為 JSON 檔案。',
                importThemeFile: '從磁碟上的 JSON 檔案載入自訂主題。',
            },
        ...
        menu: {
            ...
            tooltips: {
                ...
                options: '更多選項',
                seeDeviceHealth: '請在資訊與工具中查看裝置健康',
                moveTop: '移至頂部',
                moveBottom: '移至底部',
                disable: '停用',
                pin: '釘選至頂部',
    ...
    views: {
        ...
        appInfo: {
            ...
            calibrateFans:
                '為實現一致的控制，請{wizard}，這樣相同的 % 在每個風扇上都代表相近的速度。',
            ...
            uiTourDesc: '應用程式引導教程',
            gettingStarted: '入門指南',
            gettingStartedGraphProfile: '圖形設定檔',
            gettingStartedControlsPage: '控制項頁面',
            gettingStartedStep1: '在風扇設定檔中建立 {profile} 並調整風扇曲線。',
            gettingStartedStep2: '在 {controls}（或風扇自身的頁面）上指派它。設定檔不會自動套用。',
            gettingStartedStep3: '同一設定檔可重複用於多個風扇。',
        ...
        speed: {
            ...
            controlModeAutomaticTooltip: '將風扇設定檔套用至此通道',
            controlModeManualTooltip: '手動設定固定的工作週期百分比',
            controlModeUnmanagedTooltip: '停止管理此通道，由裝置的硬體或驅動程式決定',
    ...
    components: {
        ...
        onboarding: {
            ...
            startTourAgain: '您可以隨時從資訊與工具頁面重新啟動此導覽。',
            quickTour: '快速導覽',
            thoroughTour: '詳細導覽',
            maybeLater: '稍後',
            ...
            appInfo: '資訊與工具',
            appInfoDesc:
                '查看應用資訊、後台服務狀態、日誌、實用連結和壓力測試工具。徽標上的角標會提醒您任何問題。',
            controls: '控制項',
            controlsDesc: '從一個位置調整風扇轉速、套用設定檔並管理每個偵測到的通道。',
            profiles: '設定檔',
            profilesDesc:
                '設定檔定義風扇對溫度變化的回應方式。圖表設定檔讓您繪製自訂風扇曲線，並可在多個設備上重複使用。',
            functions: '功能',
            functionsDesc: '功能應用於設定檔，以平滑風扇轉速過渡並減少噪音。',
            systemMenu: '系統選單',
            systemMenuDesc:
                '主選單列出此系統的設備和感測器。可展開每個分區以查看其通道和指派的控制。',
            dashboards: '儀表板',
            dashboardsDesc:
            ...
            alerts: '警示',
            alertsDesc: '當感測器值超過您選擇的門檻時，警示會通知您，讓您在問題惡化之前做出反應。',
            customSensors: '自訂感測器',
            customSensorsDesc:
                '自訂感測器以不同方式組合現有感測器資料，或將您自己的腳本輸出作為溫度來源執行。',
            quickAdd: '快速添加',
            quickAddDesc: '快速建立新的儀表板、設定檔、功能等。',
            dashboardQuick: '儀表板快速選單',
            ...
            collapseMenu: '收合選單',
            collapseMenuDesc: '展開或收合主選單，為應用其餘部分騰出更多空間。',
            thatsIt: '就是這樣！',
