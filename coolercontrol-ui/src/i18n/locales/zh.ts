...
export default {
    ...
    components: {
        ...
        onboarding: {
            ...
            fansNotShowing:
                '如果您的风扇或设备没有显示或无法控制，这通常是由于缺少或过时的内核驱动程序。',
            ...
            controls: '控制器',
            controlsDesc: '控制器让您调整风扇转速、应用配置文件并管理散热设备。',
            profiles: '配置文件',
            profilesDesc:
                '配置文件定义响应温度变化的风扇曲线。同一配置文件可在多个设备上重复使用。',
            functions: '功能',
            functionsDesc: '功能应用于配置文件，以平滑风扇转速过渡并减少噪音。',
            appInfo: '应用程序信息与工具',
            appInfoDesc:
                '点击徽标查看应用信息、后台服务状态、日志和热负载工具。状态徽章会提醒您任何问题。',
            quickAdd: '快速添加',
