...
export default {
    ...
    layout: {
        ...
        settings: {
            ...
            tooltips: {
                ...
                exportThemeFile: '将当前自定义主题保存为 JSON 文件。',
                importThemeFile: '从磁盘上的 JSON 文件加载自定义主题。',
            },
    ...
    views: {
        ...
        appInfo: {
            ...
            calibrateFans:
                '为实现一致的控制，请{wizard}，这样相同的 % 在每个风扇上都意味着相近的速度。',
            ...
            uiTourDesc: '应用程序引导教程',
            gettingStarted: '入门指南',
            gettingStartedGraphProfile: '图形配置',
            gettingStartedControlsPage: '控制器页面',
            gettingStartedStep1: '在风扇配置中创建一个{profile}并调整风扇曲线。',
            gettingStartedStep2: '在{controls}（或风扇自身的页面）上分配它。配置不会自动应用。',
            gettingStartedStep3: '同一配置可以重复用于多个风扇。',
            helpSettingUp: '风扇控制设置帮助',
            hardwareSupport: '硬件支持',
            hardwareSupportDesc: '支持的设备和驱动程序安装',
            gitRepository: 'Git仓库',
            gitRepositoryDesc: '提交问题或功能请求',
            discord: 'Discord',
            discordDesc: '加入我们的Discord社区',
            whatsNew: '最新动态',
        ...
        speed: {
            ...
            controlModeAutomaticTooltip: '将风扇配置文件应用于此通道',
            controlModeManualTooltip: '手动设置固定的占空比百分比',
            controlModeUnmanagedTooltip: '停止管理此通道，由设备的硬件或驱动程序决定',
            driverNoSupportControl: '只读通道。当前驱动程序不支持设置此通道的速度。',
        ...
        functions: {
            ...
            emaCustomSensorAvailableNote:
                'EMA 也可作为自定义传感器类型使用，可让您直接绘制平滑后的温度。',
    ...
    components: {
        ...
        onboarding: {
            ...
            startTourAgain: '您可以随时从信息与工具页面重新启动此导览。',
            quickTour: '快速导览',
            thoroughTour: '详细导览',
            maybeLater: '稍后',
            ...
            appInfo: '信息与工具',
            appInfoDesc:
                '查看应用信息、后台服务状态、日志、有用链接和压力测试工具。徽标上的角标会提醒您任何问题。',
            controls: '控制器',
            controlsDesc: '从一个位置调整风扇转速、应用配置文件并管理每个检测到的通道。',
            profiles: '配置文件',
            profilesDesc:
                '配置文件定义风扇对温度变化的响应方式。图表配置文件让您绘制自定义风扇曲线，并可在多个设备上重复使用。',
            functions: '功能',
            functionsDesc: '功能应用于配置文件，以平滑风扇转速过渡并减少噪音。',
            systemMenu: '系统菜单',
            systemMenuDesc:
                '主菜单列出此系统的设备和传感器。可展开每个分区以查看其通道和分配的控制。',
            dashboards: '仪表盘',
            dashboardsDesc:
                '仪表盘让您创建自定义视图，通过图表实时监控温度、风扇转速和其他传感器数据。',
            modes: '模式',
            modesDesc: '模式是您设置的保存集合。一键在静音和性能等配置之间切换。',
            alerts: '警报',
            alertsDesc: '当传感器值超过您选择的阈值时，警报会通知您，让您在问题恶化之前做出反应。',
            customSensors: '自定义传感器',
            customSensorsDesc:
                '自定义传感器以不同方式组合现有传感器数据，或将您自己的脚本输出作为温度源运行。',
            quickAdd: '快速添加',
            quickAddDesc: '快速创建新的仪表盘、配置文件、功能等。',
            dashboardQuick: '仪表盘快速菜单',
            dashboardQuickDesc: '即使主菜单已折叠，也可跳转到任何仪表盘。',
            modesQuick: '模式快速菜单',
            ...
            collapseMenu: '折叠菜单',
            collapseMenuDesc: '展开或折叠主菜单，为应用其余部分腾出更多空间。',
            thatsIt: '就是这样！',
        ...
        wizards: {
            ...
            generate: {
                ...
                skip: '跳过',
                noFans: '未检测到可控制的风扇。',
                tempsIntro: '确认关键温度。这些值已作为最佳猜测预填，请核实。',
                cpuTemp: 'CPU 温度',
                gpuTemp: 'GPU 温度',
                liquidTemp: '液体温度',
                ambientTemp: '环境温度（可选）',
                ...
                startingPointNote:
                    '这是一个简便的起点，而不是从零开始。它们不会适合每个系统，因此创建后请核实、测试并调整。',
                replaces: '替换 {name}',
                createApply: '创建并应用',
