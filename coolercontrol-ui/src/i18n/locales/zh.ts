...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTest: '热压力测试',
            stressTestTooltip:
                '生成持续热负载以验证<br>风扇曲线和冷却配置文件。<br>这不是基准测试，而是一种方便的发热工具，<br>不用于性能测量。<br>可能会降低界面响应速度。',
            cpuStress: 'CPU 压力',
            gpuStress: 'GPU 压力',
            gpuStressTooltip: '可能需要 Vulkan 或 OpenGL ES 驱动程序。',
            ramStress: 'RAM 压力',
            driveStress: '磁盘压力',
            driveStressTooltip:
                '对块设备进行只读 I/O 压力测试。<br>使用 O_DIRECT 随机读取在磁盘控制器上<br>产生热量，不会造成任何磨损。<br>不会向磁盘写入任何数据。',
            selectDrive: '选择磁盘',
            threadCount: '线程数',
            duration: '持续时间 (秒)',
            start: '开始',
