...
export default {
    ...
    layout: {
        topbar: {
            ...
            shutdownError: '종료 신호를 보내는 동안 알 수 없는 오류가 발생했습니다. 자세한 내용은 로그를 참조하세요.',
    ...
    views: {
        daemon: {
            ...
            daemonDisconnectedDetail:
                '데몬에 연결할 수 없습니다. 데몬이 실행 중인지 확인하세요.',
        ...
        speed: {
            ...
            driverNoSupportControl:
                '현재 설치된 드라이버는 이 채널 제어를 지원하지 않습니다.',
        ...
        error: {
            ...
            nonStandardAddress:
                '표준 데몬 주소가 아닌 경우 아래에 지정할 수 있습니다:',
    ...
    components: {
        ...
        helloWorld: {
            message: "Vite + Vue 3를 사용하여 프로젝트를 성공적으로 생성하였습니다. 다음 단계는 무엇인가요?",
        },
        dashboardInfo: {
            description:
        ...
        onboarding: {
            ...
            checkDocs:
                '이슈를 제기하기 전에 모든 드라이버가 제대로 로드되었는지 확인해 주세요',
            checkingDocs: '하드웨어 지원 문서 확인',
            startTourAgain:
                '참고: 설정 페이지에서 언제든지 이 투어를 다시 시작할 수 있습니다.',
            ...
            dashboardQuickDesc: '메인 메뉴가 접혀 있는 경우에도 모든 대시보드로 바로 이동할 수 있습니다.',
            settings: '설정',
