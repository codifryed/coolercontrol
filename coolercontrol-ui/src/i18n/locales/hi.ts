...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTestTooltip:
                'फैन कर्व और कूलिंग प्रोफाइल को सत्यापित करने के लिए<br>निरंतर थर्मल लोड उत्पन्न करता है।<br>यह बेंचमार्क नहीं है, बल्कि गर्मी उत्पन्न करने की सुविधा है,<br>प्रदर्शन मापन के लिए नहीं।<br>UI प्रतिक्रियाशीलता कम हो सकती है।',
            cpuStress: 'CPU स्ट्रेस',
            gpuStress: 'GPU स्ट्रेस',
            gpuStressTooltip: 'Vulkan या OpenGL ES ड्राइवर आवश्यक हो सकते हैं।',
            ramStress: 'RAM स्ट्रेस',
            driveStress: 'ड्राइव स्ट्रेस',
            driveStressTooltip:
                'ब्लॉक डिवाइस पर केवल-पढ़ने वाला I/O स्ट्रेस।<br>O_DIRECT रैंडम रीड्स का उपयोग करके<br>बिना किसी घिसावट के ड्राइव कंट्रोलर पर गर्मी उत्पन्न करता है।<br>ड्राइव पर कोई डेटा नहीं लिखा जाता।',
