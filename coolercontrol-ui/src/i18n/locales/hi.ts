export default {
    ...
    tooltips: {
        ...
        daemonSsl:
            'SSL/TLS का उपयोग करके डेमन से कनेक्ट करना है या नहीं। एक प्रॉक्सी सेटअप की आवश्यकता है।',
        applyOnBoot: 'डेमन स्टार्टअप पर और नींद से जागने पर स्वचालित रूप से सेटिंग्स लागू करें',
        startupDelay:
            'डिवाइस संचार शुरू करने से पहले देरी (सेकंड में)। उन उपकरणों के साथ मदद करता है जिन्हें प्रारंभ करने में समय लगता है या जो रुक-रुक कर पता लगाए जाते हैं',
        thinkPadFanControl:
            'यह थिंकपैड ACPI फैन कंट्रोल को सक्षम करने के लिए एक सहायक है। फैन कंट्रोल ऑपरेशन डिफ़ॉल्ट रूप से अक्षम हैं। CoolerControl इसे आपके लिए सक्षम करने का प्रयास कर सकता है, लेकिन आपको अपने हार्डवेयर के जोखिमों के बारे में पता होना चाहिए। अपने जोखिम पर आगे बढ़ें।',
        thinkPadFullSpeed:
            'थिंकपैड लैपटॉप के लिए यह पूर्ण-गति मोड को सक्षम करता है। यह 100% पर सेट होने पर पंखे को उनके पूर्ण अधिकतम तक घुमाने की अनुमति देता है, लेकिन यह पंखे को विशिष्टता से बाहर चलाएगा और बढ़े हुए पहनने का कारण बनेगा। सावधानी के साथ उपयोग करें।',
        compress:
            'API पेलोड आकार को कम करने के लिए प्रतिक्रिया संपीड़न सक्षम करें, लेकिन ध्यान दें कि इससे CPU उपयोग बढ़ेगा।',
        liquidctlNoInit:
            'सावधानी: इसे केवल तभी अक्षम करें जब आप, या कोई अन्य प्रोग्राम, liquidctl डिवाइस प्रारंभिकरण को संभाल रहे हों। यह अन्य प्रोग्रामों के साथ संघर्ष से बचने में मदद कर सकता है।',
        hideDuplicate:
            'कुछ उपकरणों का समर्थन Liquidctl और HWMon ड्राइवरों दोनों द्वारा किया जाता है। Liquidctl को इसकी अतिरिक्त सुविधाओं के लिए डिफ़ॉल्ट रूप से उपयोग किया जाता है। इसके बजाय HWMon ड्राइवरों का उपयोग करने के लिए, इसे और liquidctl डिवाइस को अक्षम करें ताकि ड्राइवर संघर्ष से बचा जा सके।',
        liquidctl:
            'इसे अक्षम करने से Liquidctl एकीकरण पूरी तरह से निष्क्रिय हो जाएगा, चाहे coolercontrol-liqctld पैकेज की स्थापना स्थिति कुछ भी हो। यदि उपलब्ध हो, तो इसके बजाय HWMon ड्राइवरों का उपयोग किया जाएगा।',
        pollRate:
            'सेंसर डेटा को पोल करने की दर (सेकंड में)।\nएक उच्च पोल दर संसाधन उपयोग को कम करेगी, और एक कम प्रतिक्रिया क्षमता को बढ़ाएगी।\n1.0 से कम की दर का उपयोग सावधानी के साथ किया जाना चाहिए।',
    },
