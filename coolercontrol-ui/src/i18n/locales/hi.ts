...
export default {
    common: {
        ...
        toast: {
            ...
            customSensorUpdated:
                'कस्टम सेंसर सफलतापूर्वक अपडेट किया गया और यूआई रिफ्रेश हो रहा है...',
    ...
    layout: {
        ...
        plugins: {
            ...
            started: 'प्लगइन शुरू हो गया',
            stopped: 'प्लगइन रुक गया',
            restarted: 'प्लगइन पुनः आरंभ हो गया',
            startFailed: 'प्लगइन शुरू करने में विफल',
            stopFailed: 'प्लगइन रोकने में विफल',
            restartFailed: 'प्लगइन पुनः आरंभ करने में विफल',
            ...
            containerNote:
                'कंटेनर में CoolerControl चलाते समय, प्लगइन्स को स्थायी वर्चुअल साझा फ़ोल्डर में रखना होगा ताकि वे कंटेनर पुनः आरंभ के बाद भी बने रहें।',
            installedPlugins: 'इंस्टॉल किए गए प्लगइन्स',
            noPlugins: 'कोई प्लगइन इंस्टॉल नहीं',
            info: 'जानकारी',
            description: 'विवरण',
            enable: 'सक्षम करें',
            disable: 'अक्षम करें',
    ...
    views: {
        ...
        customSensors: {
            ...
            timeWindow: 'स्मूथिंग विंडो',
            timeWindowTooltip:
                'हाल के कितने सेकंड के नमूनों को एक साथ स्मूथ करना है।<br/><i>नोट: 1 से 300 सेकंड के बीच होना चाहिए।</i>',
            helpText: {
                mix: 'चुने गए फलन (न्यूनतम/अधिकतम/औसत/डेल्टा/भारित औसत) के माध्यम से कई तापमान स्रोतों को संयोजित करता है। कई सेंसरों में से सबसे गर्म से पंखे चलाने के लिए, या क्षेत्रों के बीच संतुलन के लिए उपयोग करें।',
                file: 'फ़ाइल पथ से तापमान पढ़ता है। CoolerControl द्वारा स्वतः न पहचाने जाने वाले सेंसरों के लिए उपयोग करें।',
                offset: 'तापमान स्रोत से एक निश्चित मान जोड़ता या घटाता है। ज्ञात सेंसर अशुद्धि को कैलिब्रेट करने के लिए उपयोग करें।',
                timeAverage:
                    'एक निश्चित समय विंडो पर अंकगणितीय माध्य। आउटपुट इनपुट सीमा द्वारा सीमित है और कभी ओवरशूट नहीं करता। उन पंखों के लिए जो संक्षिप्त तापमान वृद्धि को नज़रअंदाज़ करना चाहिए।',
        ...
        functions: {
            ...
            fixedStepSizeTooltip:
                'सक्षम होने पर सभी परिवर्तनों के लिए एक स्थिर स्टेप साइज़ का उपयोग करता है।\nअक्षम होने पर न्यूनतम और अधिकतम स्टेप साइज़ सीमा सेट करने की अनुमति देता है।',
            asymmetric: 'असममित',
            asymmetricTooltip:
                'सक्षम होने पर, गति वृद्धि और कमी के लिए अलग-अलग स्टेप साइज़ सीमाएं कॉन्फ़िगर की जा सकती हैं।\nजब आप चाहते हैं कि पंखे तेजी से तेज हों लेकिन धीरे-धीरे धीमे हों, या इसके विपरीत।',
            stepSizeMin: 'न्यूनतम',
            stepSizeMinTooltip:
                'सबसे छोटा पंखा गति परिवर्तन जो लागू किया जाएगा।\nइससे छोटे परिवर्तनों को अनावश्यक समायोजन कम करने के लिए अनदेखा किया जाता है।',
            stepSizeMax: 'अधिकतम',
            stepSizeMaxTooltip:
                'प्रति अपडेट अनुमत सबसे बड़ा पंखा गति परिवर्तन।\nबड़े परिवर्तनों को सुचारू संक्रमण के लिए इस मान तक सीमित किया जाता है।',
            stepSizeFixed: 'आकार',
            stepSizeFixedTooltip:
                'सभी पंखा गति परिवर्तनों पर लागू एक ही स्टेप साइज़।\nसभी समायोजन ठीक इसी मान तक सीमित होंगे।',
            stepSizeFixedIncreasing: 'वृद्धि',
            stepSizeFixedIncreasingTooltip:
                'पंखा गति बढ़ने पर स्थिर स्टेप साइज़।\nसभी ऊपर की ओर समायोजन ठीक इसी मान तक सीमित होंगे।',
            stepSizeFixedDecreasing: 'कमी',
            stepSizeFixedDecreasingTooltip:
                'पंखा गति घटने पर स्थिर स्टेप साइज़।\nसभी नीचे की ओर समायोजन ठीक इसी मान तक सीमित होंगे।',
            stepSizeMinIncreasing: 'न्यूनतम वृद्धि',
            stepSizeMinIncreasingTooltip:
                'पंखा गति बढ़ने पर न्यूनतम स्टेप साइज़।\nछोटे गणना किए गए परिवर्तनों को अनावश्यक समायोजन कम करने के लिए अनदेखा किया जाता है।',
            stepSizeMaxIncreasing: 'अधिकतम वृद्धि',
            stepSizeMaxIncreasingTooltip:
                'पंखा गति बढ़ने पर अधिकतम स्टेप साइज़।\nप्रति अपडेट पंखे कितनी तेजी से तेज हो सकते हैं इसे सीमित करता है।',
            stepSizeMinDecreasing: 'न्यूनतम कमी',
            stepSizeMinDecreasingTooltip:
                'पंखा गति घटने पर न्यूनतम स्टेप साइज़।\nछोटे गणना किए गए परिवर्तनों को अनावश्यक समायोजन कम करने के लिए अनदेखा किया जाता है।',
            ...
            hysteresisThresholdTooltip:
                'पंखा गति समायोजित करने से पहले आवश्यक न्यूनतम तापमान परिवर्तन (°C)।\nछोटे तापमान परिवर्तनों से तेज पंखा गति उतार-चढ़ाव को रोकने में मदद करता है।',
            hysteresisDelay: 'विलंब',
            ...
            thresholdHoppingTooltip:
                'जब पंखा गति 30+ सेकंड तक अपरिवर्तित रहती है, स्टेप साइज़ और हिस्टैरिसिस सीमाएं अस्थायी रूप से बाइपास हो जाती हैं।\nयह सुनिश्चित करता है कि पंखे अंततः अपनी लक्ष्य गति तक पहुंचें, यहां तक कि रूढ़िवादी थ्रेशोल्ड सेटिंग्स के साथ भी।',
        ...
        error: {
            ...
            nonStandardAddress:
                'यदि आपके पास एक गैर-मानक डेमॉन पता है, तो आप इसे नीचे निर्दिष्ट कर सकते हैं:',
        ...
        mode: {
            ...
            modeHint:
                'नोट: मोड में प्रोफाइल या फ़ंक्शन सेटिंग्स शामिल नहीं हैं, केवल चैनल कॉन्फ़िगरेशन।',
        },
        lighting: {
    ...
    components: {
        ...
        aseTek690: {
            ...
            restartRequired:
                'CoolerControl systemd सेवाओं का पुनरारंभ आवश्यक हो सकता है और यदि आवश्यक हो तो स्वचालित रूप से संभाला जाएगा।',
        ...
        wizards: {
            calibration: {
                ...
                concurrencyNote:
                    'एक साथ अधिक चलाना तेज़ है, लेकिन आस-पास के पंखे एक-दूसरे की रीडिंग को बिगाड़ सकते हैं (क्रॉस-विंड, पुश-पुल)। एक-एक करके सबसे सटीक है।',
                start: 'शुरू करें',
                close: 'बंद करें',
                running: '{total} में से {current} को कैलिब्रेट किया जा रहा है...',
                queued: 'कतार में',
                done: 'पूर्ण',
                failed: 'विफल',
                skipped: 'छोड़ा गया',
                startFailed: 'शुरू नहीं किया जा सका',
                summary: '{done} कैलिब्रेट, {failed} विफल, {skipped} छोड़े गए।',
                reloadBatch:
                    '{count} पंखे कैलिब्रेट किए गए। नया RPM-सामान्यीकृत नियंत्रण लागू करने के लिए पुनः लोड करें?',
            ...
            fanControl: {
                ...
                editCurrentProfile: 'प्रोफ़ाइल संपादित करें',
                editCurrentFunction: 'फ़ंक्शन संपादित करें',
                ...
                willCreatedAndAppliedTo: 'बनाई जाएगी और लागू की जाएगी',
                newFixedProfile: 'नई निश्चित प्रोफ़ाइल',
                withSettings: 'निम्नलिखित सेटिंग्स के साथ',
                ...
                functionDescription:
                    'फ़ंक्शन आपकी प्रोफ़ाइल को कैसे लागू किया जाता है इसे समायोजित करते हैं, जैसे प्रतिक्रिया समय और न्यूनतम ड्यूटी।',
        ...
        channelExtensionSettings: {
            ...
            calibration: {
                ...
                statusCompletedWithWarnings: 'चेतावनियों के साथ कैलिब्रेटेड: {messages}',
                statusFailed: 'अंतिम प्रयास विफल: {message}',
                warningNoTachometer: 'RPM नहीं मिला (सेंसर या तार अलग हो सकते हैं)',
                warningNotControllable:
                    'पंखा ड्यूटी पर प्रतिक्रिया नहीं देता (संभवतः BIOS‑नियंत्रित)',
                ...
                stageFinalizing: 'अंतिम रूप दे रहा है',
                buttonCalibrate: 'कैलिब्रेट करें',
                ...
                cancelError: 'कैलिब्रेशन रद्द करने में विफल',
                clearError: 'कैलिब्रेशन साफ़ करने में विफल',
                reloadHeader: 'UI पुनः लोड करें',
                reloadAccept: 'पुनः लोड करें',
                reloadReject: 'बाद में',
                reload_rpm_only_completed_single:
                    '{channelName} के लिए कैलिब्रेशन पूरा हुआ. UI पुनः लोड करें ताकि इस चैनल का ड्यूटी ग्राफ़ दिख सके.',
                reload_rpm_only_completed_multi:
                    '{channelList} के लिए कैलिब्रेशन पूरा हुआ. UI पुनः लोड करें ताकि प्रत्येक चैनल का ड्यूटी ग्राफ़ दिख सके.',
                reload_rpm_only_cleared_single:
                    '{channelName} के लिए कैलिब्रेशन साफ़ कर दिया गया. UI पुनः लोड करें ताकि अब अप्रासंगिक हो चुका इस चैनल का ड्यूटी ग्राफ़ हट जाए.',
                reload_rpm_only_cleared_multi:
                    '{channelList} के लिए कैलिब्रेशन साफ़ कर दिया गया. UI पुनः लोड करें ताकि अब अप्रासंगिक हो चुके प्रत्येक चैनल के ड्यूटी ग्राफ़ हट जाएँ.',
                reload_duty_range_completed_single:
                    '{channelName} के लिए कैलिब्रेशन पूरा हुआ. UI पुनः लोड करें ताकि मैनुअल ड्यूटी स्लाइडर और पंखा‑नियंत्रण विज़ार्ड इस चैनल की नई ड्यूटी रेंज ले लें.',
                reload_duty_range_completed_multi:
                    '{channelList} के लिए कैलिब्रेशन पूरा हुआ. UI पुनः लोड करें ताकि मैनुअल ड्यूटी स्लाइडर और पंखा‑नियंत्रण विज़ार्ड प्रत्येक चैनल की नई ड्यूटी रेंज ले लें.',
                reload_duty_range_cleared_single:
                    '{channelName} के लिए कैलिब्रेशन साफ़ कर दिया गया. UI पुनः लोड करें ताकि मैनुअल ड्यूटी स्लाइडर वापस इस चैनल की हार्डवेयर सीमाओं पर आ जाए.',
                reload_duty_range_cleared_multi:
                    '{channelList} के लिए कैलिब्रेशन साफ़ कर दिया गया. UI पुनः लोड करें ताकि मैनुअल ड्यूटी स्लाइडर वापस प्रत्येक चैनल की हार्डवेयर सीमाओं पर आ जाए.',
                reload_mixed_multi:
                    '{channelList} के लिए कैलिब्रेशन बदल गया. UI पुनः लोड करें ताकि प्रत्येक चैनल अपनी नई ड्यूटी प्रदर्शन और स्लाइडर सीमाएँ अपना ले.',
            },
        },
        calibrationCurve: {
            dialogTitle: 'कैलिब्रेशन कर्व',
            loading: 'कैलिब्रेशन लोड हो रहा है...',
            notFound: 'इस चैनल के लिए कोई कैलिब्रेशन डेटा नहीं मिला.',
            loadError: 'कैलिब्रेशन डेटा लोड करने में विफल.',
            axisDuty: 'ड्यूटी',
            axisRpm: 'RPM',
            ...
            fieldCurveKindTooltip:
                'चैनल ड्यूटी परिवर्तनों पर कैसे प्रतिक्रिया करता है.\nस्मूद पंखों का ड्यूटी-से-RPM कर्व सतत होता है, इसलिए डिस्पैचर कैलिब्रेशन के माध्यम से लक्ष्य ड्यूटी की मैपिंग करता है. स्टेप्ड पंखों के RPM प्लेटो असतत होते हैं, इसलिए ड्यूटी बिना बदलाव के पास होती है.',
            fieldRpmMax: 'अधिकतम RPM',
            fieldRpmMaxTooltip:
                'स्वीप के दौरान देखी गई सबसे अधिक RPM.\nलक्ष्य ड्यूटी को RPM‑नॉर्मलाइज़्ड वास्तविक ड्यूटी मान में बदलते समय 100% संदर्भ के रूप में उपयोग होती है.',
            fieldKick: 'किक अवधि',
            fieldKickTooltip:
                'कोल्ड स्टार्ट पर डिस्पैचर सस्टेन पर लाने से पहले किक ड्यूटी को कितनी देर बनाए रखता है.\nडिस्पैचर के सबसे खराब (बूस्ट सहित) किक ड्यूटी को रुकी अवस्था से लिखकर, और RPM के स्थिर विंडो में आने तक प्रतीक्षा करके मापा जाता है.',
            fieldStart: 'न्यूनतम स्टार्ट ड्यूटी',
            fieldStartTooltip:
                'न्यूनतम ड्यूटी जो पंखे को रुकी अवस्था से विश्वसनीय रूप से चालू करती है.\nइससे कम ड्यूटी पर पंखा शुरू नहीं हो सकता, भले ही पहले से चल रहा हो तो चलता रहता.',
            fieldSustain: 'न्यूनतम सस्टेन ड्यूटी',
            fieldSustainTooltip:
                'न्यूनतम ड्यूटी जिस पर पंखा शुरू होने के बाद चलता रहता है.\nजब तक चैनल को 0 पर नहीं भेजा जाता, डिस्पैचर चालू ड्यूटी को इस मान से नीचे नहीं ले जाएगा.',
            fieldStable: 'न्यूनतम स्थिर ड्यूटी',
            fieldStableTooltip:
                'सबसे कम ड्यूटी जिस पर पंखा बिना दोलन के चलता है.\nफर्मवेयर‑नियंत्रित पंखे कम ड्यूटी पर RPM को एक आंतरिक निचली सीमा से ऊपर धकेलते हैं, जिससे श्रव्य फड़फड़ाहट उत्पन्न होती है; डिस्पैचर किक के बाद के सस्टेन को इस मान तक सीमित कर देता है ताकि पंखा इस बैंड के ऊपर बना रहे.',
            fieldSaturate: 'पठार के समीप ड्यूटी',
            fieldSaturateTooltip:
                'वह ड्यूटी जिस पर RPM लाभ कम होने लगता है.\nपंखा इस ड्यूटी से आगे 100 % तक थोड़े और RPM जोड़ सकता है, इसलिए कैलिब्रेशन 0 से 100 % तक की पूरी ड्यूटी रेंज का उपयोग करता है.',
            fieldTimestamp: 'कैलिब्रेटेड',
            overridesHeading: 'ओवरराइड',
            fieldKickBoostOverride: 'किक बूस्ट',
            fieldKickBoostOverrideTooltip:
                'इस चैनल के लिए कोल्ड-स्टार्ट किक बूस्ट को बलपूर्वक चालू या बंद करें, या डेमन को अप-कर्व ह्यूरिस्टिक के आधार पर निर्णय लेने दें.\nबूस्ट किक ड्यूटी को संक्षेप में सस्टेन से ऊपर ले जाता है ताकि पंखे को उसकी जड़ता सीमा से आगे धकेला जा सके.',
            kickBoostAuto: 'स्वतः',
            kickBoostOn: 'बलपूर्वक चालू',
            kickBoostOff: 'बलपूर्वक बंद',
            fieldKickDurationOverride: 'किक अवधि ओवरराइड',
            fieldKickDurationOverrideTooltip:
                'कैलिब्रेट की गई किक अवधि को ओवरराइड करें. मापे गए मान का उपयोग करने के लिए खाली छोड़ें.\nयदि पंखे को सस्टेन के संभालने से पहले किक ड्यूटी पर स्थिर होने के लिए अधिक समय चाहिए तो लंबा करें.',
            kickDurationDefault: 'डिफ़ॉल्ट',
        ...
        deviceExtensionSettings: {
            title: 'उन्नत डिवाइस सेटिंग्स',
            directAccess: 'प्रत्यक्ष पहुंच',
            directAccessDesc:
                'सक्षम होने पर, liquidctl ड्राइवर HWMon कर्नेल ड्राइवर को अनदेखा करेगा\nऔर डिवाइस के साथ सीधे संचार करेगा।\nयह उन डिवाइसों के लिए सहायक हो सकता है जिनमें दोनों ड्राइवरों का उपयोग करते समय विरोध होता है।',
            useHwmon: 'HWMon ड्राइवर का उपयोग करें',
            useHwmonDesc:
                'इस डिवाइस के लिए ड्राइवर को liquidctl से HWMon कर्नेल ड्राइवर में बदलता है।\nयह प्रदर्शन और स्थिरता में सुधार कर सकता है, लेकिन उपलब्ध सुविधाओं को कम कर सकता है।',
            disableDevice: 'liquidctl डिवाइस अक्षम करें',
            disableInfo:
                'liquidctl ड्राइवर को अक्षम करने से यह डिवाइस अक्षम हो जाएगा। एक नया HWMon-आधारित डिवाइस डिवाइस मेनू के नीचे दिखाई देगा। आप सेटिंग्स मेनू से किसी भी समय liquidctl डिवाइस को फिर से सक्षम कर सकते हैं।',
            ...
            thinkPadFanControl: 'पंखा नियंत्रण',
            thinkPadFanControlDesc:
                'ThinkPad ACPI पंखा नियंत्रण सक्षम करें।\nसुरक्षा कारणों से पंखा नियंत्रण डिफ़ॉल्ट रूप से अक्षम है।\nअपने जोखिम पर आगे बढ़ें।',
            thinkPadFullSpeed: 'पूरी गति',
            thinkPadFullSpeedDesc:
                'ThinkPad पंखों के लिए पूर्ण-गति मोड सक्षम करें।\n100% पर पंखों को पूर्ण अधिकतम तक घूमने की अनुमति देता है,\nलेकिन पंखों को विशिष्टता से बाहर चलाता है जिससे घिसाव बढ़ता है।',
        },
    },
    auth: {
        ...
        tokenCreated: 'टोकन बनाया गया',
        tokenCreatedDetail: 'इस टोकन को अभी कॉपी करें। यह दोबारा नहीं दिखाया जाएगा।',
        tokenCopied: 'टोकन क्लिपबोर्ड पर कॉपी किया गया',
        tokenDeleted: 'टोकन हटाया गया',
        tokenCreateError: 'टोकन बनाने में विफल',
        tokenDeleteError: 'टोकन हटाने में विफल',
        tokenLoadError: 'टोकन लोड करने में विफल',
        tokenDeleteConfirm:
            'क्या आप वाकई इस टोकन को हटाना चाहते हैं? इसका उपयोग करने वाली सभी सेवाओं की पहुंच समाप्त हो जाएगी।',
        tokenDeleteHeader: 'टोकन हटाएं',
        noTokens: 'अभी तक कोई एक्सेस टोकन नहीं बनाया गया।',
        expires: 'समाप्ति',
        expired: 'समाप्त',
        active: 'सक्रिय',
        never: 'कभी नहीं',
