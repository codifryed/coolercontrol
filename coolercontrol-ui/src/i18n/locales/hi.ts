...
export default {
    ...
    components: {
        ...
        calibrationCurve: {
            ...
            fieldKick: 'किक अवधि',
            fieldKickTooltip:
                'बंद से शुरू करते समय डिस्पैचर पंखे को किक ड्यूटी पर कितनी देर बनाए रखता है, उसके बाद लक्ष्य पर लाता है.\nपंखे को रोककर पुनः चालू करने के बाद 50 RPM तक पहुँचने में लगा समय गुणा 1.5 (सुरक्षा मार्जिन; कम से कम 500 ms) के रूप में मापा जाता है. सेंसर पोलिंग दर डिफ़ॉल्ट रूप से 1/सेकंड है, इसलिए अधिकांश पंखे 500, 1500 या 2500 ms पर आते हैं.',
