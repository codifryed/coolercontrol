...
export default {
    ...
    views: {
        ...
        speed: {
            ...
            defaultProfileInfo:
                'डिफ़ॉल्ट प्रोफ़ाइल डिवाइस को उसकी मूल ड्राइवर सेटिंग्स पर पुनर्स्थापित करता है।<br/>कुछ ड्राइवरों में अंतर्निहित स्वचालित पंखा नियंत्रण मोड शामिल है, लेकिन <i>कई</i> में नहीं है।<br/>स्वचालित नियंत्रण के बिना उपकरणों के लिए, डिफ़ॉल्ट प्रोफ़ाइल लागू करने से<br/>पंखा अपनी अंतिम कॉन्फ़िगर की गई गति पर रहेगा और CoolerControl नियंत्रण छोड़ देगा।',
        },
        customSensors: {
            newSensor: 'नया सेंसर',
        ...
        functions: {
            ...
            functionTypeTooltip:
                'फ़ंक्शन प्रकार:<br/>- पहचान: कम्प्यूटेड प्रोफाइल मान को बदलता नहीं है।<br/>- मानक: हिस्टैरिसिस सेटिंग्स के साथ एक एल्गोरिदम का उपयोग करके प्रोफाइल मान को बदलता है।<br/>- एक्सपोनेंशियल मूविंग एवरेज: EMA एल्गोरिदम का उपयोग करके प्रोफाइल मान को बदलता है।',
    ...
    components: {
        ...
        onboarding: {
            ...
            fansNotShowing:
                'यदि आपके पंखे दिखाई नहीं दे रहे हैं या नियंत्रित नहीं किए जा सकते हैं, तो संभवतः आपके वर्तमान में इंस्टॉल किए गए कर्नेल ड्राइवरों के साथ कोई समस्या है।',
            checkDocs:
                'समस्या दर्ज करने से पहले, कृपया पुष्टि करें कि सभी ड्राइवर ठीक से लोड किए गए हैं',
            checkingDocs: 'हार्डवेयर समर्थन दस्तावेज़ीकरण की जांच करके',
            startTourAgain:
                'नोट: आप इस टूर को सेटिंग्स पेज से किसी भी समय फिर से शुरू कर सकते हैं।',
            letsStart: 'ठीक है, चलिए शुरू करते हैं!',
            dashboards: 'डैशबोर्ड',
            dashboardsDesc:
                'डैशबोर्ड आपके सिस्टम के सेंसर डेटा को देखने के लिए चार्ट का एक क्यूरेटेड संग्रह हैं।',
            controls: 'नियंत्रण',
            controlsDesc:
                'नियंत्रण आपके सिस्टम के पंखों और अन्य डिवाइसों को प्रबंधित करने के लिए एक इंटरैक्टिव इंटरफ़ेस प्रदान करते हैं। प्रत्येक नियंत्रित चैनल आपको गति समायोजित करने, प्रोफाइल सेट करने और वास्तविक समय में स्थिति की निगरानी करने की अनुमति देता है।',
            profiles: 'प्रोफाइल',
            profilesDesc:
                'प्रोफाइल पंखों की गति को नियंत्रित करने के लिए अनुकूलन योग्य सेटिंग्स परिभाषित करती हैं। एक ही प्रोफाइल कई पंखों और डिवाइसों के लिए उपयोग की जा सकती है।',
            functions: 'फंक्शन',
            functionsDesc:
                'फंक्शन कॉन्फ़िगर किए जा सकने वाले एल्गोरिदम हैं जिन्हें प्रोफाइल के आउटपुट पर लागू किया जा सकता है। यह पंखों की गति में बदलाव कब होता है, इसका प्रबंधन करने में मदद कर सकता है।',
            appInfo: 'एप्लिकेशन और डेमॉन जानकारी',
            appInfoDesc:
                'लोगो पर क्लिक करने से एप्लिकेशन जानकारी पेज खुलता है, जहां आप एप्लिकेशन, सिस्टम डेमॉन और लॉग के बारे में जानकारी प्राप्त कर सकते हैं। जब समस्या निवारण हो रहा हो तब आप वहां जाना चाहेंगे और किसी भी संभावित समस्या की सूचना देने के लिए यहां एक छोटा डेमॉन-स्थिति बैज है।',
            quickAdd: 'त्वरित जोड़',
            quickAddDesc:
                'यह नए आइटम जैसे डैशबोर्ड, प्रोफाइल, आदि को आसानी से जोड़ने के लिए एक मेनू है।',
            dashboardQuick: 'डैशबोर्ड त्वरित मेनू',
            dashboardQuickDesc:
                'यह आपके डैशबोर्ड पर जल्दी से जाने के लिए एक मेनू है, भले ही मुख्य मेनू संकुचित हो।',
            settings: 'सेटिंग्स',
            settingsDesc: 'यह बटन विभिन्न UI और डेमॉन सेटिंग्स वाला सेटिंग्स पेज खोलेगा।',
            restartMenu: 'पुनरारंभ मेनू',
            restartMenuDesc:
                'यहां आप UI को पुनः लोड करने या सिस्टम डेमॉन को पुनरारंभ करने का चयन कर सकते हैं।',
            thatsIt: 'बस इतना ही!',
        ...
        wizards: {
            fanControl: {
                ...
                editCurrentProfile: 'वर्तमान प्रोफ़ाइल संपादित करें',
                editCurrentFunction: 'वर्तमान फ़ंक्शन संपादित करें',
                currentSettings: 'वर्तमान सेटिंग्स देखें',
                manualSpeed: 'मैनुअल पंखा गति सेट करें',
                createNewProfile: 'नई प्रोफ़ाइल बनाएं',
                existingProfile: 'मौजूदा प्रोफ़ाइल चुनें',
                ...
                createNewFunction: 'नया फ़ंक्शन बनाएं',
                existingFunction: 'मौजूदा फ़ंक्शन चुनें',
                defaultFunction: 'डिफ़ॉल्ट फ़ंक्शन का उपयोग करें',
