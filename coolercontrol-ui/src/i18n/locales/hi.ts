...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTestTooltip:
                'फैन कर्व और कूलिंग प्रोफाइल को सत्यापित करने के लिए<br>निरंतर थर्मल लोड उत्पन्न करता है।<br>परिणाम हार्डवेयर के अनुसार भिन्न हो सकते हैं।<br>गहन परीक्षण के लिए, अपने पसंदीदा स्ट्रेस<br>या बेंचमार्किंग टूल का उपयोग करें।',
