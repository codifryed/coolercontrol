...
export default {
    ...
    tooltips: {
        ...
        compressApiPayload:
            'API पेलोड आकार को कम करने के लिए प्रतिक्रिया संपीड़न सक्षम करें,\nलेकिन ध्यान दें कि इससे CPU उपयोग बढ़ेगा।',
    ...
    views: {
        ...
        functions: {
            ...
            minimumAdjustmentTooltip:
                'न्यूनतम पंखा गति समायोजन: इस मान से नीचे की गणना किए गए परिवर्तनों को अनदेखा किया जाएगा।',
            maximumAdjustment: 'अधिकतम समायोजन',
            maximumAdjustmentTooltip:
                'अधिकतम पंखा गति समायोजन: इस सीमा से ऊपर की गणना किए गए परिवर्तनों को सीमित किया जाएगा।',
            windowSize: 'विंडो आकार',
            windowSizeTooltip:
                'विंडो आकार सेट करके तापमान परिवर्तनों के प्रति संवेदनशीलता समायोजित करें।\nछोटे विंडो आकार परिवर्तनों पर तेजी से प्रतिक्रिया करते हैं,\nजबकि बड़े विंडो आकार अधिक सहज औसत प्रदान करते हैं।',
            hysteresisThreshold: 'हिस्टैरिसिस थ्रेशोल्ड',
            hysteresisThresholdTooltip:
                'तापमान परिवर्तन सीमा (°C): तापमान में इस मात्रा से परिवर्तन होने पर पंखा गति समायोजित करें।',
            hysteresisDelay: 'हिस्टैरिसिस विलंब',
            hysteresisDelayTooltip:
                'तापमान परिवर्तनों पर प्रतिक्रिया करने के लिए आवश्यक समय (सेकंड)।',
