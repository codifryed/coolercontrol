...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTestTooltip:
                'फैन कर्व और कूलिंग प्रोफाइल को सत्यापित करने के लिए<br>निरंतर थर्मल लोड उत्पन्न करता है।<br>यह बेंचमार्क नहीं है, बल्कि गर्मी उत्पन्न करने की सुविधा है,<br>प्रदर्शन मापन के लिए नहीं।<br>GPU स्ट्रेस के लिए Vulkan या OpenGL ES ड्राइवर आवश्यक हो सकते हैं।<br>UI प्रतिक्रियाशीलता कम हो सकती है।',
