...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTestTooltip:
                'फैन कर्व और कूलिंग प्रोफाइल को सत्यापित करने के लिए<br>निरंतर थर्मल लोड उत्पन्न करता है।<br>परिणाम हार्डवेयर के अनुसार भिन्न हो सकते हैं।<br>बेहतर परिणामों के लिए stress-ng इंस्टॉल करें।',
            ...
            driveStressTooltip:
                'ड्राइव कंट्रोलर पर गर्मी उत्पन्न करने के लिए<br>ब्लॉक डिवाइस पर I/O स्ट्रेस।',
        ...
        speed: {
            ...
            defaultProfileInfo:
                'डिफ़ॉल्ट प्रोफ़ाइल CoolerControl को इस पंखे का प्रबंधन बंद करने<br/>और मूल ड्राइवर सेटिंग्स पुनर्स्थापित करने का निर्देश देता है।<br/><br/><b>चेतावनी:</b> कई ड्राइवरों में स्वचालित पंखा नियंत्रण <i>नहीं</i> होता।<br/>ऐसे उपकरणों पर, पंखा बिना किसी सक्रिय प्रबंधन के<br/>अपनी अंतिम निर्धारित गति पर बना रहेगा।',
        },
        customSensors: {
            newSensor: 'नया सेंसर',
    ...
    components: {
        ...
        onboarding: {
            ...
            fansNotShowing:
                'यदि आपके पंखे या डिवाइस दिखाई नहीं दे रहे हैं या नियंत्रित नहीं किए जा सकते, तो यह अक्सर गायब या पुराने कर्नेल ड्राइवरों के कारण होता है।',
            checkDocs:
            ...
            controls: 'नियंत्रण',
            controlsDesc:
                'नियंत्रण आपको पंखे की गति समायोजित करने, प्रोफ़ाइल लागू करने और कूलिंग डिवाइस प्रबंधित करने देते हैं।',
            profiles: 'प्रोफाइल',
            profilesDesc:
                'प्रोफ़ाइल तापमान परिवर्तनों के अनुसार पंखे की कर्व परिभाषित करती हैं। एक ही प्रोफ़ाइल को कई डिवाइसों पर पुनः उपयोग करें।',
            functions: 'फंक्शन',
            functionsDesc:
                'फंक्शन प्रोफ़ाइल पर लागू होते हैं ताकि पंखे की गति परिवर्तन सुचारू हो और शोर कम हो।',
            appInfo: 'एप्लिकेशन जानकारी और उपकरण',
            appInfoDesc:
                'लोगो पर क्लिक करके एप जानकारी, डेमॉन स्टेटस, लॉग और थर्मल लोड टूल्स देखें। स्टेटस बैज समस्याओं की सूचना देता है।',
            ...
            thatsIt: 'बस इतना ही!',
            ready: 'यदि डिवाइस गायब हैं या नियंत्रित नहीं हो रहे, तो प्रयास करें',
            startNow: 'सब तैयार!',
        },
        axisOptions: {
            title: 'अक्ष विकल्प',
