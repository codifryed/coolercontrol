...
export default {
    ...
    views: {
        ...
        appInfo: {
            ...
            stressTestTooltip:
                'निरंतर CPU या GPU थर्मल लोड उत्पन्न करके<br>फैन कर्व और कूलिंग प्रोफाइल को सत्यापित करें।<br>स्ट्रेस टेस्ट प्रत्येक सिस्टम के कई घटकों का उपयोग करते हैं<br>अधिकतम गर्मी उत्पन्न करने के लिए।',
            cpuStress: 'CPU स्ट्रेस',
            gpuStress: 'GPU स्ट्रेस',
            gpuStressTooltip:
                'Vulkan या OpenGL ES (ANGLE के माध्यम से) ड्राइवर आवश्यक हैं।<br>डेस्कटॉप UI प्रतिक्रियाशीलता कम हो सकती है।',
            threadCount: 'थ्रेड्स',
            duration: 'अवधि (सेकंड)',
            start: 'शुरू करें',
            stop: 'रोकें',
