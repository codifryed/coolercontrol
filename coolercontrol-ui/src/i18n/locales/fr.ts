export default {
  common: {
    ...
    toast: {
      ...
      customSensorUpdated: 'Capteur Personnalisé mis à jour avec succès et Actualisation de l\'UI...',
      customSensorDeleted: 'Capteur Personnalisé supprimé avec succès et Actualisation de l\'UI...',
      ...
      settingsError: 'Une erreur s\'est produite lors de la tentative d\'application de ces paramètres',
  ...
  views: {
    ...
    profiles: {
      ...
      tooltip: {
        profileType: 'Type de profil :<br/>- Par défaut : Conserve les paramètres actuels du périphérique<br/>&nbsp;&nbsp;(BIOS/firmware)<br/>- Fixe : Définit une vitesse constante<br/>- Graphique : Courbe de ventilateur personnalisable<br/>- Mixte : Combine plusieurs profils'
      },
      ...
      profileUpdateError: 'Une erreur est survenue lors de la tentative de mise à jour de ce profil',
