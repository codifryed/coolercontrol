export default {
  ...
  views: {
    ...
    profiles: {
      ...
      tooltip: {
        profileType: 'Profiltyp:<br/>- Standard: Behält aktuelle Geräteeinstellungen bei<br/>&nbsp;&nbsp;(BIOS/Firmware)<br/>- Fest: Stellt eine konstante Geschwindigkeit ein<br/>- Grafik: Anpassbare Lüfterkurve<br/>- Mix: Kombiniert mehrere Profile'
      },
      ...
      profileUpdateError: 'Bei dem Versuch, dieses Profil zu aktualisieren, ist ein Fehler aufgetreten',
      tempSourceRequired: 'Für ein Grafikprofil ist eine Temperaturquelle erforderlich.',
      memberProfilesRequired: 'Für ein Mischprofil sind mindestens 2 Mitgliedsprofile erforderlich.'
    },
    controls: {
