export default {
  ...
  layout: {
    topbar: {
      ...
      restartConfirmMessage: 'Sind Sie sicher, dass Sie den Daemon und die UI neustarten möchten?',
      restartConfirmHeader: 'Daemon Neustart',
      shutdownSuccess: 'Daemon-Shutdown-Signal akzeptiert',
      shutdownError: 'Unbekannter Fehler beim Senden des Shutdown-Signals. Details finden Sie in den Logs.',
    ...
    settings: {
      ...
      devices: {
        ...
        toggleRequiresRestart: 'Das Umschalten von Geräten oder Sensoren erfordert einen Neustart des Daemons und der UI. Möchten Sie das jetzt tun?',
        enableDevices: 'Geräte aktivieren',
        selectTooltip: 'Wählen Sie Geräte und Sensoren aus, um sie zu deaktivieren oder zu aktivieren.\nDas Deaktivieren ungenutzter Geräte und Sensoren wird dringend empfohlen.',
        unknownError: 'Unbekannter Fehler beim Versuch, Änderungen auf alle Geräte anzuwenden. Details finden Sie in den Logs.'
      },
      profiles: 'Profile',
      alerts: 'Warnungen',
      ...
      tooltips: {
        ...
        frequencyPrecision: 'Stellen Sie die Genauigkeit der angezeigten Frequenzwerte ein.',
        sidebarCollapse: 'Ob ein Menü-Einklapp-Symbol in der Seitenleiste angezeigt werden soll,\noder der leere Bereich der Seitenleiste genutzt wird, um das Hauptmenü zu erweitern oder einzuklappen.',
        entitiesBelowSensors: 'Ob Entitäten unter Gerätesensoren im Hauptmenü angezeigt werden sollen.',
        ...
        daemonSsl: 'Ob eine Verbindung zum Daemon über SSL/TLS hergestellt werden soll. Ein Proxy-Setup ist erforderlich.',
        applyOnBoot: 'Einstellungen automatisch beim Daemon-Start und beim Aufwachen aus dem Ruhezustand anwenden',
        startupDelay: 'Verzögerung vor dem Start der Gerätekommunikation (in Sekunden). Hilft bei Geräten, die Zeit zur Initialisierung benötigen oder nicht durchgängig erkannt werden',
        thinkPadFanControl: 'Dies ist ein Hilfsmittel zum Aktivieren der ThinkPad ACPI-Lüftersteuerung. Lüftersteuerungsoperationen sind aus Sicherheitsgründen standardmäßig deaktiviert. CoolerControl kann versuchen, dies für Sie zu aktivieren, aber Sie sollten sich der Risiken für Ihre Hardware bewusst sein. Fahren Sie auf eigenes Risiko fort.',
        thinkPadFullSpeed: 'Für Thinkpad-Laptops aktiviert dies den Vollgeschwindigkeitsmodus. Dies ermöglicht es den Lüftern, bei Einstellung auf 100% auf ihr absolutes Maximum hochzudrehen, wird die Lüfter jedoch außerhalb der Spezifikation betreiben und zu erhöhtem Verschleiß führen. Verwenden Sie es mit Vorsicht.',
        compress: 'Aktivieren Sie die Antwortkomprimierung, um die API-Payload-Größe zu reduzieren, beachten Sie jedoch, dass dies die CPU-Auslastung erhöht.',
        liquidctlNoInit: 'Vorsicht: Deaktivieren Sie dies NUR, wenn Sie oder ein anderes Programm die Liquidctl-Geräteinitialisierung handhaben. Dies kann helfen, Konflikte mit anderen Programmen zu vermeiden.',
        hideDuplicate: 'Einige Geräte werden sowohl von Liquidctl- als auch von HWMon-Treibern unterstützt. Liquidctl wird standardmäßig wegen seiner zusätzlichen Funktionen verwendet. Um stattdessen HWMon-Treiber zu verwenden, deaktivieren Sie dies und das Liquidctl-Gerät, um Treiberkonflikte zu vermeiden.',
        liquidctl: 'Durch Deaktivieren wird die Liquidctl-Integration vollständig deaktiviert, unabhängig vom Installationsstatus des coolercontrol-liqctld Pakets. Falls verfügbar, werden stattdessen HWMon-Treiber verwendet.',
        pollRate: 'Die Rate, mit der Sensordaten abgefragt werden (in Sekunden).\nEine höhere Abfragerate reduziert die Ressourcennutzung, und eine niedrigere erhöht die Reaktionsfähigkeit.\nEine Rate von weniger als 1,0 sollte mit Vorsicht verwendet werden.'
      },
      applySettingAndRestart: 'Das Ändern dieser Einstellung erfordert einen Neustart des Daemons und der UI. Möchten Sie das jetzt tun?',
      ...
      languageChangeConfirmMessage: 'Das Ändern der Sprache erfordert ein Neuladen der Seite. Fortfahren?'
    },
    menu: {
      system: 'System',
      dashboards: 'Dashboards',
  ...
  views: {
    daemon: {
      ...
      daemonErrorsDetail: 'Der Daemon hat Fehler gemeldet. Überprüfen Sie die Logs für Details.',
      daemonDisconnected: 'Daemon getrennt',
      daemonDisconnectedDetail: 'Verbindung zum Daemon nicht möglich. Bitte überprüfen Sie, ob der Daemon läuft.',
      ...
      changeSetting: 'Das Ändern dieser Einstellung erfordert einen Neustart des Daemons und der UI. Möchten Sie das jetzt tun?',
      status: {
        ok: 'Ok',
    ...
    devices: {
      ...
      selectDevices: 'Wählen Sie Geräte und Sensoren aus, um sie zu deaktivieren oder zu aktivieren.\nDas Deaktivieren ungenutzter Geräte und Sensoren wird dringend empfohlen.',
      devicesAndSensors: 'Geräte und Sensoren',
      apply: 'Anwenden',
      applySettingsAndReload: 'Einstellungen anwenden und neu laden',
      triggersAutoRestart: 'Löst automatischen Daemon-Neustart aus',
      restartPrompt: 'Das Umschalten von Geräten oder Sensoren erfordert einen Neustart des Daemons und der UI. Möchten Sie das jetzt tun?',
      enableDevices: 'Geräte aktivieren'
    },
    speed: {
      ...
      driverNoSupportControl: 'Der aktuell installierte Treiber unterstützt nicht die Steuerung dieses Kanals.',
    ...
    customSensors: {
      ...
      filePathTooltip: 'Geben Sie den absoluten Pfad zur Temperaturdatei ein, die für diesen Sensor verwendet werden soll.\nDie Datei muss das sysfs-Datenformat-Standard verwenden:\nEine Festkommazahl in Milligrad Celsius.\nz.B. 80000 für 80°C.\nDie Datei wird bei der Übermittlung überprüft.',
      browse: 'Durchsuchen',
      browseCustomSensorFile: 'Nach einer benutzerdefinierten Sensordatei suchen',
      tempSources: 'Temp-Quellen',
      tempSourcesTooltip: 'Temperaturquellen, die in der Mix-Funktion verwendet werden sollen<br/><i>Hinweis: Sie können ein Mix-Profil verwenden, um mehrere<br/>benutzerdefinierte Sensoren zu kombinieren.</i>',
      ...
      unsavedChanges: 'Es gibt ungespeicherte Änderungen an diesem benutzerdefinierten Sensor.',
      ...
      deleteCustomSensorConfirm: 'Sind Sie sicher, dass Sie den benutzerdefinierten Sensor löschen möchten: "{name}"?'
    },
    dashboard: {
      ...
      clear: 'Löschen',
      deleteDashboard: 'Dashboard löschen',
      deleteDashboardConfirm: 'Sind Sie sicher, dass Sie das Dashboard löschen möchten: "{name}"?',
    ...
    appInfo: {
      ...
      openIssue: 'Problem melden',
      openIssueDesc: 'Fehler melden, Funktionen anfragen',
    ...
    profiles: {
      ...
      selectedPointDuty: 'Auslastung des ausgewählten Punkts',
      selectedPointTemp: 'Temperatur des ausgewählten Punkts',
      tempSource: 'Temperaturquelle',
      memberProfiles: 'Mitgliedsprofile',
      mixFunction: 'Mix-Funktion',
      applyMixFunction: 'Mix-Funktion auf ausgewählte Profile anwenden',
      profilesToMix: 'Profile zum Mischen',
      saveProfile: 'Profil speichern',
      function: 'Funktion',
      functionToApply: 'Anzuwendende Funktion',
      graphProfileMouseActions: 'Grafikprofil-Mausaktionen:\n- Scrollen zum Zoomen.\n- Linksklick auf die Linie, um einen Punkt hinzuzufügen.\n- Rechtsklick auf einen Punkt zum Entfernen.\n- Punkt ziehen, um zu verschieben.',
      unsavedChanges: 'Es gibt ungespeicherte Änderungen an diesem Profil.',
      unsavedChangesHeader: 'Ungespeicherte Änderungen',
      appliedFunction: 'Angewandte Funktion',
      newProfile: 'Neues Profil',
      tooltip: {
        profileType: 'Profiltyp:<br/>- Standard: Behält aktuelle Geräteeinstellungen bei<br/>&nbsp;&nbsp;(BIOS/Firmware)<br/>- Fest: Setzt eine konstante Geschwindigkeit<br/>- Graph: Anpassbare Lüfterkurve<br/>- Mix: Kombiniert mehrere Profile'
      },
      ...
      deleteProfileWithChannelsConfirm: '"{name}" wird derzeit verwendet von: {channels}.\nDas Löschen dieses Profils wird die Einstellungen dieser Kanäle zurücksetzen.\nSind Sie sicher, dass Sie "{name}" löschen möchten?',
      profileUpdated: 'Profil aktualisiert',
      profileUpdateError: 'Beim Versuch, dieses Profil zu aktualisieren, ist ein Fehler aufgetreten'
    },
    controls: {
    ...
    modes: {
      ...
      updateModeConfirm: 'Sind Sie sicher, dass Sie "{name}" mit der aktuellen Konfiguration überschreiben möchten?',
    ...
    functions: {
      ...
      functionTypeTooltip: 'Funktionstypen:\n- Identität: Verändert den berechneten Profilwert nicht.\n- Standard: Verändert den Profilwert mithilfe eines Algorithmus mit Hysterese-Einstellungen.\n- Exponentieller gleitender Durchschnitt: Verändert den Profilwert mithilfe eines EMA-Algorithmus.',
      minimumAdjustment: 'Minimale Anpassung',
      minimumAdjustmentTooltip: 'Minimale Lüftergeschwindigkeitsanpassung: Berechnete Änderungen unter diesem Wert werden ignoriert.',
      maximumAdjustment: 'Maximale Anpassung',
      maximumAdjustmentTooltip: 'Maximale Lüftergeschwindigkeitsanpassung: Berechnete Änderungen über diesem Schwellenwert werden begrenzt.',
      windowSize: 'Fenstergröße',
      windowSizeTooltip: 'Passen Sie die Empfindlichkeit gegenüber Temperaturänderungen an, indem Sie die Fenstergröße einstellen.\nKleinere Fenstergrößen reagieren schnell auf Änderungen,\nwährend größere Fenstergrößen gleichmäßigere Durchschnitte liefern.',
      hysteresisThreshold: 'Hysterese-Schwellenwert',
      hysteresisThresholdTooltip: 'Temperaturänderungsschwellenwert (°C): Passen Sie die Lüftergeschwindigkeit an, wenn sich die Temperatur um diesen Betrag ändert.',
      hysteresisDelay: 'Hysterese-Verzögerung',
      hysteresisDelayTooltip: 'Zeit (Sekunden), die benötigt wird, um auf Temperaturänderungen zu reagieren.',
      ...
      deleteFunctionWithProfilesConfirm: '"{name}" wird derzeit von den Profilen verwendet: {profiles}.\nDas Löschen dieser Funktion wird die Funktionen dieser Profile zurücksetzen.\nSind Sie sicher, dass Sie "{name}" löschen möchten?',
      functionUpdated: 'Funktion aktualisiert',
      functionUpdateError: 'Beim Versuch, diese Funktion zu aktualisieren, ist ein Fehler aufgetreten'
    },
    error: {
      connectionError: 'CoolerControl-Verbindungsfehler',
      connectionToast: 'Verbindung zum Daemon nicht möglich',
      connectionToastDetail: 'Verbindung zum Daemon nicht möglich. Bitte stellen Sie sicher, dass der Dienst läuft und versuchen Sie, erneut zu verbinden.',
      connectionRetryFailure: 'Verbindung fehlgeschlagen - Wiederholungsversuch fehlgeschlagen',
      connectionRetryDetail: 'Konnte nach mehreren Versuchen keine Verbindung zum Daemon herstellen.',
      errorLoadingGraph: 'Fehler beim Laden des Diagramms',
      highCpuUsageWarning: 'Hohe CPU-Auslastung erkannt',
      highCpuUsageDetail: 'Die aktuelle CPU-Auslastung ist hoch.\nUm die Systembelastung zu reduzieren, erwägen Sie:\n1. Die Anzahl der angezeigten Diagramme zu reduzieren\n2. Die Anzahl der überwachten Sensoren zu reduzieren\n3. Das Abfrageintervall zu erhöhen',
      ...
      nonStandardAddress: 'Wenn Sie eine nicht standardmäßige Daemon-Adresse haben, können Sie sie unten angeben:',
      daemonAddressDesktop: 'Daemon-Adresse (Desktop-App)',
      daemonAddressWeb: 'Daemon-Adresse (Web-UI)',
      addressTooltip: 'Die IP-Adresse oder der Domainname, mit dem eine Verbindung hergestellt werden soll.',
    ...
    singleDashboard: {
      minutes: "min",
      chartMouseActions: "Dashboard-Mausaktionen:\n- Markieren zum Zoomen.\n- Scrollen zum Zoomen.\n- Rechtsklick zum Schwenken im gezoomten Zustand.\n- Doppelklick zum Zurücksetzen und fortsetzen der Aktualisierung.",
      timeRange: "Zeitbereich",
      chartType: "Diagrammtyp"
    },
    mode: {
      ...
      modeHint: "Hinweis: Modi enthalten keine Profil- oder Funktionseinstellungen, nur Kanalkonfigurationen."
    },
    lighting: {
      ...
      numberOfColorsTooltip: "Anzahl der Farben, die für den ausgewählten Beleuchtungsmodus verwendet werden sollen."
    },
    lcd: {
  ...
  components: {
    ...
    aseTek690: {
      sameDeviceID: 'Die Legacy-NZXT-Krakens und die EVGA CLC haben zufällig dieselbe Geräte-ID, und CoolerControl kann nicht feststellen, welches Gerät angeschlossen ist. Dies ist für die ordnungsgemäße Gerätekommunikation erforderlich.',
      restartRequired: 'Ein Neustart der CoolerControl systemd-Dienste kann erforderlich sein und wird bei Bedarf automatisch durchgeführt.',
    ...
    alertInfo: {
      description: 'Warnungen werden verwendet, um Sie zu benachrichtigen, wenn bestimmte Bedingungen auftreten. Sie können Temperaturen und Lüftergeschwindigkeiten überwachen, um sicherzustellen, dass Ihr System ordnungsgemäß läuft. Warnungen werden für bestimmte Sensorwertbereiche konfiguriert und senden Benachrichtigungen, wenn Werte überschritten werden oder in akzeptable Schwellenwertbereiche zurückkehren.'
    },
    customSensorInfo: {
      title: 'Benutzerdefinierte Sensor-Übersicht',
      description: 'Benutzerdefinierte Sensoren ermöglichen es Ihnen, bestehende Sensoren auf verschiedene Weise zu kombinieren und verbessern Ihre Kontrolle und Effizienz bei der Systemkühlung. Zusätzlich unterstützen sie dateibasierte Daten, die es Ihnen ermöglichen, externe Sensoreingaben für größere Flexibilität zu skripten.',
      note: 'Hinweis: Sie können Mix-Profile verwenden, um mehrere benutzerdefinierte Sensorausgaben zu kombinieren.'
    },
    functionInfo: {
      title: 'Funktionsübersicht',
      description: 'Funktionen sind konfigurierbare Algorithmen, die auf Profilausgaben angewendet werden. Sie ermöglichen es Ihnen, zu verwalten, wann Lüftergeschwindigkeitsänderungen auftreten, Hysterese-Einstellungen anzupassen und gleitende Durchschnitte für dynamische Temperaturen zu verwenden.',
      identityFunction: 'Die Identitätsfunktion ist die einfachste Option, da sie die berechnete Profilausgabe nicht modifiziert; sie erlaubt es Ihnen nur, minimale und maximale Geschwindigkeitsänderungsbereiche festzulegen. Dies ist besonders vorteilhaft, um ständige Lüftergeschwindigkeitsschwankungen zu minimieren.'
    },
    profileInfo: {
      title: 'Profilübersicht',
      description: 'Profile definieren anpassbare Einstellungen zur Steuerung der Lüftergeschwindigkeiten, wobei dasselbe Profil für mehrere Lüfter verwendet werden kann. Typen umfassen:',
      type: {
      ...
      additionalInfo: 'Profile sind die Grundlage für die Steuerung der Lüftergeschwindigkeiten und können durch Anwendung fortschrittlicherer Algorithmusfunktionen weiter verbessert werden.'
    },
    deviceInfo: {
    ...
    onboarding: {
      ...
      beforeStart: 'Bevor wir beginnen, ist eine der wichtigsten Dinge, die Sie wissen sollten,',
      settingUpDrivers: 'das Einrichten Ihrer Hardware-Treiber',
      fansNotShowing: 'Wenn Ihre Lüfter nicht angezeigt werden oder nicht gesteuert werden können, dann gibt es wahrscheinlich ein Problem mit Ihren derzeit installierten Kernel-Treibern.',
      checkDocs: 'Bevor Sie ein Problem melden, stellen Sie bitte sicher, dass alle Treiber ordnungsgemäß geladen wurden, indem Sie',
      checkingDocs: 'die Hardware-Support-Dokumentation überprüfen',
      startTourAgain: 'Hinweis: Sie können diese Tour jederzeit über die Einstellungsseite erneut starten.',
      letsStart: 'Ok, lass uns beginnen!',
      dashboards: 'Dashboards',
      dashboardsDesc: 'Dashboards sind eine kuratierte Sammlung von Diagrammen zur Ansicht der Sensordaten Ihres Systems.',
      profiles: 'Profile',
      profilesDesc: 'Profile definieren anpassbare Einstellungen zur Steuerung der Lüftergeschwindigkeiten. Dasselbe Profil kann für mehrere Lüfter und Geräte verwendet werden.',
      functions: 'Funktionen',
      functionsDesc: 'Funktionen sind konfigurierbare Algorithmen, die auf die Ausgabe eines Profils angewendet werden können. Dies kann hilfreich sein, um zu verwalten, wann Lüftergeschwindigkeitsänderungen auftreten.',
      appInfo: 'Anwendungs- und Daemon-Informationen',
      appInfoDesc: 'Durch Klicken auf das Logo wird die Anwendungsinformationsseite geöffnet, wo Sie Informationen über die Anwendung, den Systemdaemon und Logs erhalten können. Hier sollten Sie bei der Fehlerbehebung nachsehen, und es gibt ein kleines Daemon-Status-Symbol, das Sie über potenzielle Probleme informiert.',
      quickAdd: 'Schnelles Hinzufügen',
      quickAddDesc: 'Dies ist ein Menü, um neue Elemente wie Dashboards, Profile usw. einfach hinzuzufügen.',
      dashboardQuick: 'Dashboard-Schnellmenü',
      dashboardQuickDesc: 'Dies ist ein Menü, um schnell zu Ihren Dashboards zu springen, auch wenn das Hauptmenü eingeklappt ist.',
      settings: 'Einstellungen',
      settingsDesc: 'Diese Schaltfläche öffnet die Einstellungsseite mit verschiedenen UI- und Daemon-Einstellungen.',
      restartMenu: 'Neustart-Menü',
      restartMenuDesc: 'Hier können Sie wählen, ob Sie die UI neu laden oder den Systemdaemon neu starten möchten.',
      thatsIt: 'Das war\'s!',
  ...
  device: {
    ...
    modelSetRestartInProgress: 'Gerätemodelltyp erfolgreich festgelegt. Neustart wird durchgeführt.'
  },
  device_store: {
    unauthorized: {
    ...
    asetek: {
      ...
      success: {
        summary: 'Erfolg',
        detail_legacy: 'Gerätemodelltyp erfolgreich festgelegt. Neustart wird durchgeführt.',
