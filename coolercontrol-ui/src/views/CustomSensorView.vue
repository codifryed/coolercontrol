<!--
  ...
  import { ChannelViewType, SensorAndChannelSettings, getChannelViewTypeDisplayName } from '@/models/UISettings.ts'
      ...
      <div class="flex border-b-4 border-border-one items-center justify-between">
          <div class="flex pl-4 py-2 text-2xl overflow-hidden">
              <span class="font-bold overflow-hidden overflow-ellipsis">{{
                  shouldCreateSensor ? `${t('views.customSensors.newSensor')}: ${currentName}` : currentName
              }}</span>
          </div>
              ...
              >
                  ...
                  >
                      ...
                      <DataTable :value="chosenTempSources">
                          <Column field="tempFrontendName" :header="t('views.customSensors.tempName')" body-class="w-full">
