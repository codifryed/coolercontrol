...
Build-Depends: debhelper-compat (= 13), nodejs, cargo (>= 1.88) | cargo-1.88, libdrm-dev, protobuf-compiler, build-essential, cmake (>= 3.15), libgl1-mesa-dev, libqt6opengl6-dev, qt6-base-dev, qt6-webengine-dev, qt6-webengine-dev-tools
Package-List:
