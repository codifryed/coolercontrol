...
#[derive(Debug)]
pub struct HydroProSupport;

impl HydroProSupport {
    pub fn new() -> Self {
        Self {}
    }
}

impl DeviceSupport for HydroProSupport {
    ...
    fn get_color_channel_modes(&self, _channel_name: Option<&str>) -> Vec<LightingMode> {
        let color_modes: Vec<ColorMode> = vec![
            ...
            ColorMode::new("blinking", 1, 4, true, false),
            ColorMode::new("pulse", 1, 4, true, false),
            ColorMode::new("shift", 2, 4, true, false),
            ColorMode::new("alert", 3, 3, false, false),
        ];
